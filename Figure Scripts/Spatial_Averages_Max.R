...
setwd("C:/Users/levis/OneDrive/Desktop/Urban Climate/Reanalysis/NetCDF Files/spatialavs10m/mx")
...
t.one <- nc_open("sp.wrfout_d03_2010-07-01_wdcmx_10m.nc")
...
t.two <- nc_open("sp.wrfout_d03_2010-07-02_wdcmx_10m.nc")
...
t.three <- nc_open("sp.wrfout_d03_2010-07-03_wdcmx_10m.nc")
...
t.four <- nc_open("sp.wrfout_d03_2010-07-04_wdcmx_10m.nc")
...
t.five <- nc_open("sp.wrfout_d03_2010-07-05_wdcmx_10m.nc")
...
t.six <- nc_open("sp.wrfout_d03_2010-07-06_wdcmx_10m.nc")
...
t.seven <- nc_open("sp.wrfout_d03_2010-07-07_wdcmx_10m.nc")
...
t.eight <- nc_open("sp.wrfout_d03_2010-07-08_wdcmx_10m.nc")
...
t.nine <- nc_open("sp.wrfout_d03_2010-07-09_wdcmx_10m.nc")
...
t.ten <- nc_open("sp.wrfout_d03_2010-07-10_wdcmx_10m.nc")
...
setwd("C:/Users/levis/OneDrive/Desktop/Urban Climate/Reanalysis/NetCDF Files/spatialavs100m/mx")

h.one <- nc_open("sp.wrfout_d03_2010-07-01_wdcmx_100m.nc")
temp.h.one <- ncvar_get(h.one, "T2")
PBLH.h.one <- ncvar_get(h.one, "PBLH")
Qtwo.h.one <- ncvar_get(h.one, "Q2")
PSFC.h.one <- ncvar_get(h.one, "PSFC")

h.two <- nc_open("sp.wrfout_d03_2010-07-02_wdcmx_100m.nc")
temp.h.two <- ncvar_get(h.two, "T2")
PBLH.h.two <- ncvar_get(h.two, "PBLH")
Qtwo.h.two <- ncvar_get(h.two, "Q2")
PSFC.h.two <- ncvar_get(h.two, "PSFC")

h.three <- nc_open("sp.wrfout_d03_2010-07-03_wdcmx_100m.nc")
...
h.four <- nc_open("sp.wrfout_d03_2010-07-04_wdcmx_100m.nc")
...
h.five <- nc_open("sp.wrfout_d03_2010-07-05_wdcmx_100m.nc")
...
h.eight <- nc_open("sp.wrfout_d03_2010-07-08_wdcmx_100m.nc")
...
h.nine <- nc_open("sp.wrfout_d03_2010-07-09_wdcmx_100m.nc")
...
h.ten <- nc_open("sp.wrfout_d03_2010-07-10_wdcmx_100m.nc")
...
Pmax <- ggplot(dfP, aes(x=days)) + geom_line(aes(y=PBLH.t), color="darkred", size = 1.5) + geom_line(aes(y=PBLH.h), color="blue", size = 1.5) + labs(title = "Maximum PBLH", x = "Days", y = "Atmospheric Boundary Layer Thickness (m)") + scale_x_continuous(breaks=seq(1,10, by = 1)) + theme_bw()

temp.hist <- c(80, 82, 86, 94, 98, 102, 101, 93, 93, 81)
humid.hist <- c(55, 54, 65, 73, 73, 74, 65, 74, 79, 94)
dfTh <- data.frame(days, temp.hist)
dfHh <- data.frame(days, humid.hist)
dfTt <- data.frame(days,temp.t.F,temp.h.F,temp.hist, narbor.max)
...
Ttmax <- ggplot(dfTt, aes(x=days)) + geom_line(aes(y=temp.t.F), color="darkred", size=1.5) + geom_line(aes(y=temp.h.F), color="blue", size=1.5) + geom_line(aes(y=temp.hist), color="black", size=1, linetype="dashed") + geom_line(aes(y=narbor.av), color="darkgreen", size =1, linetype="dotted") + geom_line(aes(y=tmax.F), linetype=4, color="purple", size=1) + labs(title = "Maximum Temperatures", x = "Days", y = "Temperature (F)") + scale_x_continuous(breaks=seq(1,10, by = 1)) + scale_y_continuous(breaks=seq(60,105, by = 5)) + theme_bw()
Htmax <- ggplot(dfHt, aes(x=days)) + geom_line(aes(y=humid.t), color="darkred", size=1.5) + geom_line(aes(y=humid.h), color="blue", size=1.5) + geom_line(aes(y=humid.hist), color="black", size=1, linetype="dashed") + geom_line(aes(y=rh.max), linetype=4, color="purple", size=1) + labs(title = "Maximum Relative Humidity", x = "Days", y = "Humidity (%)") + scale_x_continuous(breaks=seq(1,10, by = 1)) + scale_y_continuous(breaks=seq(35,100, by = 5)) + theme_bw()

ggarrange(Ttmax,Htmax)
